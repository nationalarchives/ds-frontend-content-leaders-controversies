...
function lcLoadMenus() {
  ...
  lc_menu_0.addMenuItem("Source&nbsp;1","location='g5cs3s1a.htm'");
  lc_menu_0.addMenuItem("Source&nbsp;2","location='g5cs3s2a.htm'");
  lc_menu_0.addMenuItem("Source&nbsp;3","location='g5cs3s3a.htm'");
