...
function lcLoadMenus() {
  ...
  lc_menu_0.addMenuItem("Source&nbsp;1","location='g2cs4s1.htm'");
  lc_menu_0.addMenuItem("Source&nbsp;2","location='g2cs4s2a.htm'");
  lc_menu_0.addMenuItem("Source&nbsp;3","location='g2cs4s3.htm'");
