...
function lcLoadMenus() {
  ...
  lc_menu_0.addMenuItem("Source&nbsp;4","location='g4cs3s4.htm'");
  lc_menu_0.addMenuItem("Source&nbsp;5","location='g4cs3s5.htm'");
  lc_menu_0.addMenuItem("Source&nbsp;6","location='g4cs3s6.htm'");
  lc_menu_0.addMenuItem("Source&nbsp;7","location='g4cs3s7.htm'");
  lc_menu_0.addMenuItem("Source&nbsp;8","location='g4cs3s8.htm'");
